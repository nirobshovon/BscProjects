...
void startGame(){
    ...
    /*glColor3f(0.000, 0.000, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move+26-2,5);
    glVertex2f(move+26-2,7);
    glVertex2f(move+30+2,7);
    glVertex2f(move+30+2,5);
    glEnd();*/
        //Back Tire
    glColor3f(0.000, 0.000, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move+26-2,1);
    glVertex2f(move+26-2,3);
    glVertex2f(move+30+2,3);
    glVertex2f(move+30+2,1);
    glEnd();
        //Car Body
    glColor3f(0.678, 1.000, 0.184);
    glBegin(GL_POLYGON);
    glVertex2f(move+26,1);
    glVertex2f(move+26,8);
    glColor3f(0.000, 0.545, 0.545);

    glVertex2f(move+28,10);
    glVertex2f(move+30,8);
    glVertex2f(move+30,1);
    glEnd();
    ...
    glColor3f(0.000, 0.000, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move1+26-2,car1+100-4);
    glVertex2f(move1+26-2,car1+100-6);
    glVertex2f(move1+30+2,car1+100-6);
    glVertex2f(move1+30+2,car1+100-4);
    glEnd();
    glColor3f(0.000, 0.000, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move1+26-2,car1+100);
    glVertex2f(move1+26-2,car1+100-2);
    glVertex2f(move1+30+2,car1+100-2);
    glVertex2f(move1+30+2,car1+100);
    glEnd();
    glColor3f(1.000, 0.000, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move1+26,car1+100);
    glVertex2f(move1+26,car1+100-7);
    glVertex2f(move1+28,car1+100-9);
    glVertex2f(move1+30,car1+100-7);
    glVertex2f(move1+30,car1+100);
    glEnd();
    car1--;
    if(car1<-100){
        car1=0;
    ...
    //KIll check car1
    if((abs(move-move1)<8) && (car1+100<10)){
            start = 0;
            gv=1;
    ...
    glColor3f(0.000, 0.000, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move2+26-2,car2+100-4);
    glVertex2f(move2+26-2,car2+100-6);
    glVertex2f(move2+30+2,car2+100-6);
    glVertex2f(move2+30+2,car2+100-4);
    glEnd();
    glColor3f(0.000, 0.000, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move2+26-2,car2+100);
    glVertex2f(move2+26-2,car2+100-2);
    glVertex2f(move2+30+2,car2+100-2);
    glVertex2f(move2+30+2,car2+100);
    glEnd();
    glColor3f(0.294, 0.000, 0.510);
    glBegin(GL_POLYGON);
    glVertex2f(move2+26,car2+100);
    glVertex2f(move2+26,car2+100-7);
    glVertex2f(move2+28,car2+100-9);
    glVertex2f(move2+30,car2+100-7);
    glVertex2f(move2+30,car2+100);
    glEnd();
    car2--;
    if(car2<-100){
        car2=0;
    ...
    //KIll check car2
    if((abs(move-move2)<8) && (car2+100<10)){
            start = 0;
            gv=1;
    }
    ...
    glColor3f(0.000, 0.000, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move3+26-2,car3+100-4);
    glVertex2f(move3+26-2,car3+100-6);
    glVertex2f(move3+30+2,car3+100-6);
    glVertex2f(move3+30+2,car3+100-4);
    glEnd();
    glColor3f(0.000, 0.000, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move3+26-2,car3+100);
    glVertex2f(move3+26-2,car3+100-2);
    glVertex2f(move3+30+2,car3+100-2);
    glVertex2f(move3+30+2,car3+100);
    glEnd();
    glColor3f(1.000, 0.271, 0.000);
    glBegin(GL_POLYGON);
    glVertex2f(move3+26,car3+100);
    glVertex2f(move3+26,car3+100-7);
    glVertex2f(move3+28,car3+100-9);
    glVertex2f(move3+30,car3+100-7);
    glVertex2f(move3+30,car3+100);
    glEnd();
    car3--;
    if(car3<-100){
        car3=0;
    ...
    //KIll check car3
    if((abs(move-move3)<8) && (car3+100<10)){
            start = 0;
            gv=1;
...
void fristDesign(){
      ...
      glColor3f(0.133, 0.545, 0.133);
        ...
        renderBitmapString(30-5,50-43,(void *)font3,"RAHAT Shovon Irfan");
